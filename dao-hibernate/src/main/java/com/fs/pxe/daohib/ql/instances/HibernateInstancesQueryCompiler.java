package com.fs.pxe.daohib.ql.instances;
...
import com.fs.pxe.ql.eval.skel.AbstractConjunction;
import com.fs.pxe.ql.eval.skel.AbstractDisjunction;
import com.fs.pxe.ql.eval.skel.AbstractEqualityEvaluator;
import com.fs.pxe.ql.eval.skel.CommandEvaluator;
import com.fs.pxe.ql.eval.skel.ConjunctionEvaluator;
import com.fs.pxe.ql.eval.skel.DisjunctionEvaluator;
import com.fs.pxe.ql.eval.skel.EqualityEvaluator;
import com.fs.pxe.ql.eval.skel.GEEvaluator;
import com.fs.pxe.ql.eval.skel.GreaterEvaluator;
import com.fs.pxe.ql.eval.skel.INEvaluator;
import com.fs.pxe.ql.eval.skel.LEEvaluator;
import com.fs.pxe.ql.eval.skel.LessEvaluator;
import com.fs.pxe.ql.eval.skel.LikeEvaluator;
import com.fs.pxe.ql.eval.skel.OrderByEvaluator;
import com.fs.pxe.ql.tree.Builder;
import com.fs.pxe.ql.tree.BuilderFactory;
import com.fs.pxe.ql.tree.nodes.Equality;
import com.fs.pxe.ql.tree.nodes.Field;
import com.fs.pxe.ql.tree.nodes.GE;
import com.fs.pxe.ql.tree.nodes.Greater;
import com.fs.pxe.ql.tree.nodes.Identifier;
import com.fs.pxe.ql.tree.nodes.IdentifierToValueCMP;
import com.fs.pxe.ql.tree.nodes.In;
import com.fs.pxe.ql.tree.nodes.LE;
import com.fs.pxe.ql.tree.nodes.Less;
import com.fs.pxe.ql.tree.nodes.Like;
import com.fs.pxe.ql.tree.nodes.Limit;
import com.fs.pxe.ql.tree.nodes.LogicExprNode;
import com.fs.pxe.ql.tree.nodes.LogicNode;
import com.fs.pxe.ql.tree.nodes.Node;
import com.fs.pxe.ql.tree.nodes.OrderBy;
import com.fs.pxe.ql.tree.nodes.OrderByElement;
import com.fs.pxe.ql.tree.nodes.OrderByType;
import com.fs.pxe.ql.tree.nodes.Property;
import com.fs.pxe.ql.tree.nodes.Query;
import com.fs.pxe.ql.tree.nodes.Value;
import com.fs.pxe.ql.tree.nodes.ValuesHelper;
...
public class HibernateInstancesQueryCompiler extends Compiler<List, Session> {
  private static class DBFieldValueEq extends FieldValueEquality {
    ...
    /**
     * @see com.fs.pxe.ql.eval.skel.CommandEvaluator#evaluate(java.lang.Object)
     */
  ...
  public CommandEvaluator compileEvaluator(Object node) {
    ...
    } else if (node instanceof com.fs.pxe.ql.tree.nodes.Conjunction) {
      return compileConjunction(evaluate((LogicExprNode) node));
    } else if (node instanceof com.fs.pxe.ql.tree.nodes.Disjunction) {
