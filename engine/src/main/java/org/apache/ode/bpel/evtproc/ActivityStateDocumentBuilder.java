...
/**
 * Class used to generate {@link org.apache.ode.bpel.pmapi.istate.InstanceDocument} objects.
 */
public class ActivityStateDocumentBuilder implements BpelEventListener {
    ...
    /**
     * Keep a list of the activity info objects, so we can return them in the order of creation.
     */
