 ...
 * {@link com.fs.pxe.bpel.parser.BpelProcessBuilderFactory} to create an instance of
 * this interface.
 * </p>
 */
public interface BpelProcessBuilder {
   ...
   */
  com.fs.pxe.bom.api.Process parse(InputSource bpelSource, String id) throws BpelParseException;
