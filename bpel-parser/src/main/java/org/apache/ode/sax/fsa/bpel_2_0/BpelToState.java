...
class BpelToState extends BaseBpelState {
    ...
    protected BpelObject createBpelObject(StartElement se) throws ParseException {
        XmlAttributeSpec PLINK = new FilterSpec(new String[] {"partnerLink"},new String[] {});
        XmlAttributeSpec VAR = new FilterSpec(new String[] {"variable"}, new String[] {"part"});
        XmlAttributeSpec VAR_PROP = new FilterSpec(new String[] {"variable","property"},new String[] {});
