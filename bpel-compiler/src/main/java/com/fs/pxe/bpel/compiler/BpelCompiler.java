 ...
 * into compiled representations suitable for execution by the PXE BPEL Service Provider.
...
abstract class BpelCompiler implements CompilerContext {
  ...
  private com.fs.pxe.bom.api.Process _processDef;
  ...
  public void addWsdlImport(URI wsdlImport) {
    ...
    try {
      ...
      // TODO PXE-107 Make URI resolution relative
  ...
  public OProcess compile(final Process process) throws CompilationException {
    ...
    _konstExprLang.properties.put("runtime-class", "com.fs.pxe.bpel.runtime.explang.konst.KonstExpressionLanguageRuntimeImpl");
