...
public class CommonCompilationMessages extends CompilationMessageBundle {
  ...
  public CompilationMessage errPropertyDeclaredWithComplexType(QName propertyName,
      QName complexType) {
    return this.formatCompilationMessage(
   ...
   */
  public CompilationMessage errUndeclaredMessagePart(String varName, QName messageType,
      String partName) {
