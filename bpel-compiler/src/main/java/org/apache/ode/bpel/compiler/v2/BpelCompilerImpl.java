...
import org.apache.ode.bpel.rtrep.v2.OFlow;
...
import org.apache.ode.bpel.rtrep.v2.ORethrow;
 ...
 */
abstract class BpelCompilerImpl extends BaseCompiler implements CompilerContext, BpelCompiler {
    /** Class-severity logger. */
    protected static final Log __log = LogFactory.getLog(BpelCompilerImpl.class);
    ...
    BpelCompilerImpl(WSDLFactory4BPEL wsdlFactory) {
    ...
    protected void registerExpressionLanguage(String expLangUri, String classname) {
        try {
