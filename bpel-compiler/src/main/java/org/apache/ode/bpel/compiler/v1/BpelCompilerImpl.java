 ...
 */
abstract class BpelCompilerImpl implements CompilerContext, org.apache.ode.bpel.compiler.BpelCompiler {
    ...
    private OConstants makeConstants() {
        ...
        // adding new fields in OConstants breaks compatibility
