 ...
 * <code>&lt;extensionActivity&gt;</code> activity contains a nested DOM element that represents the
 * actual extension element. According to the BPEL 2.0 PR1 specification, the standards elements and
 * standards attributes are not located in the extensionActivity element but in the nested element.
 * Therefore the convenient access methods for standards attributes/elements are overridden to refer
