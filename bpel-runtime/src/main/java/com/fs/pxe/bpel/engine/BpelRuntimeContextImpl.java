...
import com.fs.pxe.bpel.evt.CorrelationSetWriteEvent;
import com.fs.pxe.bpel.evt.ProcessCompletionEvent;
...
import com.fs.pxe.bpel.evt.ProcessMessageExchangeEvent;
...
import com.fs.pxe.bpel.runtime.BpelAbstraction;
import com.fs.pxe.bpel.runtime.BpelRuntimeContext;
import com.fs.pxe.bpel.runtime.CorrelationSetInstance;
...
import com.fs.pxe.bpel.runtime.VariableInstance;
...
class BpelRuntimeContextImpl implements BpelRuntimeContext {
  ...
  /**
   * @see BpelRuntimeContext#isCorrelationInitialized(com.fs.pxe.bpel.runtime.CorrelationSetInstance)
   */
  ...
  /**
   * @see BpelRuntimeContext#isVariableInitialized(com.fs.pxe.bpel.runtime.VariableInstance)
   */
  ...
  /**
   * @see BpelRuntimeContext#completedFault(com.fs.pxe.bpel.runtime.channels.FaultData)
   */
  ...
  /**
   * @see BpelRuntimeContext#createScopeInstance(Long, com.fs.pxe.bpel.o.OScope)
   */
  ...
  /**
   * @see BpelRuntimeContext#readCorrelation(com.fs.pxe.bpel.runtime.CorrelationSetInstance)
   */
   ...
   * @throws com.fs.pxe.bpel.common.FaultException
  ...
  /**
   * @see BpelRuntimeContext#writeCorrelation(com.fs.pxe.bpel.runtime.CorrelationSetInstance,
  ...
  /**
   * @see BpelRuntimeContext#sendEvent(com.fs.pxe.bpel.evt.ProcessInstanceEvent)
   */
