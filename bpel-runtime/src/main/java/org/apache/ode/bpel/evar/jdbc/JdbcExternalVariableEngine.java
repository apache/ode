...
import org.apache.ode.bpel.evar.jdbc.DbExternalVariable.Column;
import org.apache.ode.bpel.evar.jdbc.DbExternalVariable.RowKey;
import org.apache.ode.bpel.evar.jdbc.DbExternalVariable.RowVal;
...
public class JdbcExternalVariableEngine implements ExternalVariableModule {
    ...
    public Value writeValue(Value newval) throws ExternalVariableModuleException {
        ...
        RowKey key = evar.generateKey(newval.locator);
    ...
    RowVal execSelect(DbExternalVariable dbev, Locator locator) throws SQLException, ExternalVariableModuleException {
        RowKey rowkey = dbev.generateKey(locator);
