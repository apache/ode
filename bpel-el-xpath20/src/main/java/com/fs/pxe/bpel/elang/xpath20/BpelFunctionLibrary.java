...
import com.fs.pxe.bpel.elang.xpath10.compiler.*;
import com.fs.pxe.bpel.elang.xpath10.o.OXPath10Expression;
import com.fs.pxe.bpel.elang.xpath10.o.OXPath10ExpressionBPEL20;
import com.fs.pxe.bpel.elang.xpath10.runtime.XslRuntimeUriResolver;
import com.fs.pxe.bpel.elang.xpath20.runtime.FaultXPathException;
...
public class BpelFunctionLibrary implements FunctionLibrary {
  ...
  public static class GetVariableFunc extends BaseBpelFunction {
    ...
    /**
     * @see com.fs.pxe.bpel.elang.xpath20.BpelFunctionLibrary.BaseBpelFunction#compile(com.fs.pxe.bpel.capi.CompilerContext, com.fs.pxe.bpel.elang.xpath10.o.OXPath10Expression)
     */
    public void compile(CompilerContext cctx, OXPath10Expression oxpath) throws CompilationException, XPathException {
